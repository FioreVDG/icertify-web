...
import { ROLE_FORM } from './access-role-form.config';
@Component({
...
export class AccessRoleFormComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<AccessRoleFormComponent>,
  ...
  save() {
    ...
    let body = {
      ...
      _barangay:
        this.data.brgyDetails !== 'undefined'
          ? this.data.brgyDetails
          : undefined,
      _notaryId:
